...
//          context.globals.graphics_state.camera_transform = Mat4.look_at( Vec.of( 0, -20, 15 ), Vec.of( 0,0,0 ), Vec.of( 0,10, 0 ) );
        ...
        this.materials =     
          { pond:          context.get_instance( Phong_Shader ).material( Color.of( 0, 123/255, 167/255, .5 ), { ambient: 0.3} ),
            ...
            rudd_Fish:      context.get_instance( Phong_Shader ).material( Color.of(0,0,0,1), { ambient: 1, texture: context.get_instance( "assets/RuddFish.png", false ) } ),
        ...
        this.fish3D_Matrix = Mat4.identity().times( Mat4.rotation( 1, Vec.of( 1, 0, -.1)))
    ...
    make_control_panel()
      { 
        ...
        this.key_triggered_button( "Start Game", [ "s" ], () => { if(!this.begin_animation)
...
//                   this.caught_fish_matrix[1][3] = 100;
      ...
      draw_the_enviroment(graphics_state, t) {
       ...
       // this.shapes.rock.draw( graphics_state, this.rock_Matrix, this.materials.rock);
        this.shapes.plane.draw( graphics_state, this.backdrop_Matrix, this.materials.pond.override( { color: Color.of( 0, 1, 1, 1), ambient: .8}));
